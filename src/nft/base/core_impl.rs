use crate::nft::base::{NonFungibleTokenCore, NonFungibleTokenResolver};
...
use crate::nft::metadata::{TokenId, TokenMetadata, TokenRarity, TokenCollection, TokenType, TokenSubType, Token};
use crate::nft::utils::{refund_approved_account_ids, hash_account_id};
...
impl NonFungibleToken {
  pub fn new<Q1, Q2, Q3, Q4, Q5, Q6, Q7, Q8>(
    owner_by_id_prefix: Q1,
    token_metadata_prefix: Option<Q2>,
    enumeration_prefix: Option<Q3>,
    approval_prefix: Option<Q4>,

    token_rarity_prefix: Option<Q5>,
    token_collection_prefix: Option<Q6>,
    token_type_prefix: Option<Q7>,
    token_sub_type_prefix: Option<Q8>,
  ) -> Self
    where
      Q1: IntoStorageKey,
      Q2: IntoStorageKey,
